	...
	UploadForm_initialHook
{
	...
	public function onMessageCacheFetchOverrides( array &$keys ): void {
		...
		static $keysToOverride = [
			...
			"userrights-restricted-group-founder",
			"userrights-restricted-group-global-interface-editor",
			"userrights-restricted-group-global-sysop",
			"userrights-restricted-group-interface-admin",
			"userrights-restricted-group-new-wikis-importer",
			"userrights-restricted-group-oauthadmin",
			"userrights-restricted-group-ombuds",
			"userrights-restricted-group-staff",
			"userrights-restricted-group-steward",
			"userrights-restricted-group-suppress",
			"userrights-restricted-group-sysadmin",
			"userrights-restricted-group-translationadmin",
			"userrights-restricted-group-u4c-member",
			"userrights-restricted-group-wikidata-staff",
			"userrights-restricted-group-wikifunctions-staff",
			"userrights-restricted-group-wmf-email-block-override",
			"userrights-restricted-group-wmf-officeit",
			"userrights-restricted-group-wmf-researcher",
			"userrights-restricted-group-wmf-supportsafety",
			"userrights-restricted-group-abusefilter-helper-private-conditions",
			"userrights-restricted-group-abusefilter-maintainer-private-conditions",
			...
			"userrights-restricted-group-founder-private-conditions",
			"userrights-restricted-group-global-interface-editor-private-conditions",
			"userrights-restricted-group-global-sysop-private-conditions",
			"userrights-restricted-group-interface-admin-private-conditions",
			"userrights-restricted-group-new-wikis-importer-private-conditions",
			"userrights-restricted-group-oauthadmin-private-conditions",
			"userrights-restricted-group-ombuds-private-conditions",
			"userrights-restricted-group-staff-private-conditions",
			"userrights-restricted-group-steward-private-conditions",
			"userrights-restricted-group-suppress-private-conditions",
			"userrights-restricted-group-sysadmin-private-conditions",
			"userrights-restricted-group-translationadmin-private-conditions",
			"userrights-restricted-group-u4c-member-private-conditions",
			...
			"userrights-restricted-group-wmf-email-block-override-private-conditions",
			"userrights-restricted-group-wmf-officeit-private-conditions",
			"userrights-restricted-group-wmf-researcher-private-conditions",
	...
	public static function onRegistration() {
		...
		$wgGrammarForms['sh'] = [
			'genitiv' => [
				'Wikiknjige'          => 'Wikiknjiga',
				'Wikipodaci'          => 'Wikipodataka',
				'Wikifunkcije'        => 'Wikifunkcija',
				'Wikimedijina ostava' => 'Wikimedijine ostave',
				'Wikipedija'          => 'Wikipedije',
				'Wikicitat'           => 'Wikicitata',
				'Wikiteka'            => 'Wikiteke',
				'Wikivrste'           => 'Wikivrsta',
				'Wikiverzitet'        => 'Wikiverziteta',
				'Wikivodič'           => 'Wikivodiča',
				'Wikirječnik'         => 'Wikirječnika',
				'projekt'             => 'projekta',
			],
			'dativ' => [
				'Wikiknjige'          => 'Wikiknjigama',
				'Wikipodaci'          => 'Wikipodacima',
				'Wikifunkcije'        => 'Wikifunkcijama',
				'Wikimedijina ostava' => 'Wikimedijinoj ostavi',
				'Wikinovosti'         => 'Wikinovostima',
				'Wikipedija'          => 'Wikipediji',
				'Wikicitat'           => 'Wikicitatu',
				'Wikiteka'            => 'Wikiteci',
				'Wikivrste'           => 'Wikivrstama',
				'Wikiverzitet'        => 'Wikiverzitetu',
				'Wikivodič'           => 'Wikivodiču',
				'Wikirječnik'         => 'Wikirječniku',
				'projekt'             => 'projektu',
			],
			'akuzativ' => [
				'Wikipodaci'          => 'Wikipodatke',
				'Wikimedijina ostava' => 'Wikimedijinu ostavu',
				'Wikipedija'          => 'Wikipediju',
				'Wikiteka'            => 'Wikiteku',
				// To support the descriptive declension
				'projekt'             => 'projekt',
			],
			'vokativ' => [
				'Wikimedijina ostava' => 'Wikimedijina ostavo',
				'Wikipedija'          => 'Wikipedijo',
				'Wikicitat'           => 'Wikicitate',
				'Wikiteka'            => 'Wikiteko',
				'Wikiverzitet'        => 'Wikiverzitete',
				'Wikivodič'           => 'Wikivodiču',
				'Wikirječnik'         => 'Wikirječniče',
				'projekt'             => 'projekte',
			],
			'instrumental' => [
				'Wikiknjige'          => 'Wikiknjigama',
				'Wikipodaci'          => 'Wikipodacima',
				'Wikifunkcije'        => 'Wikifunkcijama',
				'Wikimedijina ostava' => 'Wikimedijinom ostavom',
				'Wikinovosti'         => 'Wikinovostima',
				'Wikipedija'          => 'Wikipedijom',
				'Wikicitat'           => 'Wikicitatom',
				'Wikiteka'            => 'Wikitekom',
				'Wikivrste'           => 'Wikivrstama',
				'Wikiverzitet'        => 'Wikiverzitetom',
				'Wikivodič'           => 'Wikivodičem',
				'Wikirječnik'         => 'Wikirječnikom',
				'projekt'             => 'projektom',
			],
			'lokativ' => [
				'Wikiknjige'          => 'Wikiknjigama',
