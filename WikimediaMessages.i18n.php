...
$messages['sr-ec'] = array(
	...
	'group-arbcom-member' => 'члан Арбитражног одбора',
	'group-autopatrolled-member' => 'аутопатролер',
	'group-autoreviewer-member' => 'самооцењивач',
	...
	'group-filemover-member' => 'премештач датотека',
	'group-flood-member' => 'корисник-бот',
	'group-founder-member' => 'оснивач',
	'group-import-member' => 'увозник',
	'group-interface_editors-member' => 'уредник сучеља',
	'group-ipblock-exempt-member' => 'Изузетак од ИП блокирања',
	'group-patroller-member' => 'патролер',
	...
	'grouppage-accountcreator' => '{{ns:project}}:Отварачи налога',
	...
	'group-editinterface-member' => 'уредник сучеља',
