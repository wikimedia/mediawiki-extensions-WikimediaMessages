...
{{doc-important|Only change the link if it has a translation!|([http://wikimediafoundation.org/wiki/Special:Prefixindex/Donate/ check])}}',
	...
	'group-bigexport' => 'Big export user has a right to: {{Mediawiki:Right-override-export-depth}}',
	...
	'group-bigexport-member' => 'Big export user has a right to: {{Mediawiki:Right-override-export-depth}}',
...
Big export user has a right to: {{Mediawiki:Right-override-export-depth}}',
...
$messages['fr'] = array(
	...
	'group-bigexport' => 'Grand exportateurs',
	'group-abusefilter' => "Modificateurs des filtres d'abus",
	...
	'group-abusefilter-member' => "modificateur des filtres d'abus",
	...
	'grouppage-abusefilter' => "{{ns:project}}:Modificateurs des filtres d'abus",
	'group-steward' => 'Stewards',
